    ...
    <div className="p-4 w-full md:w-1/4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm mb-8">
        ...
        <div className="flex flex-wrap gap-4">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md w-full md:w-auto justify-center ${
              viewType === "grid"
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm mb-8">
        ...
        <button
          ...
          className="bg-emerald-400 text-white px-6 py-2 rounded-md hover:bg-emerald-500 transition-colors w-full"
        >
          We&apos;re Listening!
        </button>
      </div>
